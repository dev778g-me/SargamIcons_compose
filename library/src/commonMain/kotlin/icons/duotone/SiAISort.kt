...
val Sargam.Duotone.SiAISort: ImageVector
    get() {
        if (_SiAISort != null) {
            return _SiAISort!!
        }
        _SiAISort = ImageVector.Builder(
            name = "Duotone.SiAISort",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcTo(1.6f, 1.6f, 0f, isMoreThanHalf = false, isPositiveArc = true, 21f, 4.6f)
                ...
                verticalLineTo(4.6f)
                arcTo(1.6f, 1.6f, 0f, isMoreThanHalf = false, isPositiveArc = true, 15.6f, 3f)
                moveTo(4.6f, 14f)
                horizontalLineToRelative(3.8f)
                arcToRelative(1.6f, 1.6f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.6f, 1.6f)
                verticalLineToRelative(3.8f)
