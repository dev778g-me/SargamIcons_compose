    ...
    get() {
        ...
        _SiPhoneCallback = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                close()
                moveTo(14.922f, 5.586f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.5f, 0f)
                close()
                moveTo(14.172f, 9.828f)
                horizontalLineToRelative(-0.75f)
                verticalLineToRelative(0.75f)
                horizontalLineToRelative(0.75f)
                close()
                moveTo(18.414f, 10.578f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0f, -1.5f)
                close()
                moveTo(20.359f, 4.702f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.06f, -1.06f)
                close()
                moveTo(6.652f, 10.802f)
                lineTo(13.155f, 17.262f)
                ...
                close()
                moveTo(13.422f, 5.586f)
                verticalLineToRelative(4.242f)
                horizontalLineToRelative(1.5f)
                lineTo(14.922f, 5.586f)
                close()
                moveTo(14.172f, 10.578f)
                horizontalLineToRelative(4.242f)
                verticalLineToRelative(-1.5f)
                horizontalLineToRelative(-4.242f)
                close()
                moveTo(14.702f, 10.358f)
                lineTo(20.359f, 4.702f)
                lineTo(19.299f, 3.642f)
                lineTo(13.641f, 9.298f)
                close()
            }
        }.build()
