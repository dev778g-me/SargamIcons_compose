...
val Sargam.Duotone.SiRemoveSquare: ImageVector
    get() {
        if (_SiRemoveSquare != null) {
            return _SiRemoveSquare!!
        }
        _SiRemoveSquare = ImageVector.Builder(
            name = "Duotone.SiRemoveSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SiRemoveSquare: ImageVector? = null
