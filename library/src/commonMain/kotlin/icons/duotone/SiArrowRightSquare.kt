...
val Sargam.Duotone.SiArrowRightSquare: ImageVector
    get() {
        if (_SiArrowRightSquare != null) {
            return _SiArrowRightSquare!!
        }
        _SiArrowRightSquare = ImageVector.Builder(
            name = "Duotone.SiArrowRightSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SiArrowRightSquare: ImageVector? = null
