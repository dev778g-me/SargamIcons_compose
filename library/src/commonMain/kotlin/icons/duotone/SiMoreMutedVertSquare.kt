...
val Sargam.Duotone.SiMoreMutedVertSquare: ImageVector
    get() {
        if (_SiMoreMutedVertSquare != null) {
            return _SiMoreMutedVertSquare!!
        }
        _SiMoreMutedVertSquare = ImageVector.Builder(
            name = "Duotone.SiMoreMutedVertSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SiMoreMutedVertSquare: ImageVector? = null
