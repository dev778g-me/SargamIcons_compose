...
val Sargam.Duotone.SiFlagAlt4: ImageVector
    get() {
        if (_SiFlagAlt4 != null) {
            return _SiFlagAlt4!!
        }
        _SiFlagAlt4 = ImageVector.Builder(
            name = "Duotone.SiFlagAlt4",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(9.03f, 9.03f, 0f, isMoreThanHalf = false, isPositiveArc = false, 5.99f, 0.684f)
                lineTo(21f, 15.064f)
                lineToRelative(-0.005f, -10.116f)
                lineToRelative(-3.061f, 0.705f)
                arcToRelative(9.03f, 9.03f, 0f, isMoreThanHalf = false, isPositiveArc = true, -5.99f, -0.685f)
                lineToRelative(-0.106f, -0.052f)
                arcToRelative(9.03f, 9.03f, 0f, isMoreThanHalf = false, isPositiveArc = false, -6.111f, -0.657f)
                lineTo(3f, 4.927f)
                moveToRelative(0f, 10.117f)
