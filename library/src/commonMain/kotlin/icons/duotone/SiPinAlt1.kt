...
val Sargam.Duotone.SiPinAlt1: ImageVector
    get() {
        if (_SiPinAlt1 != null) {
            return _SiPinAlt1!!
        }
        _SiPinAlt1 = ImageVector.Builder(
            name = "Duotone.SiPinAlt1",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(7.077f, 4.065f)
                arcToRelative(6.905f, 6.905f, 0f, isMoreThanHalf = false, isPositiveArc = true, 9.85f, 0f)
                curveToRelative(2.758f, 2.773f, 2.758f, 7.21f, 0.038f, 9.945f)
                lineTo(12.002f, 19f)
                lineTo(7.04f, 14.01f)
                arcToRelative(7.034f, 7.034f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0f, -9.907f)
                close()
                moveTo(12f, 6.5f)
