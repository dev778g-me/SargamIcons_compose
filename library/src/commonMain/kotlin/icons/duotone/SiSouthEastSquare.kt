...
val Sargam.Duotone.SiSouthEastSquare: ImageVector
    get() {
        if (_SiSouthEastSquare != null) {
            return _SiSouthEastSquare!!
        }
        _SiSouthEastSquare = ImageVector.Builder(
            name = "Duotone.SiSouthEastSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SiSouthEastSquare: ImageVector? = null
