...
val Sargam.Regular.SiArrowUpwardSquare: ImageVector
    get() {
        if (_SiArrowUpwardSquare != null) {
            return _SiArrowUpwardSquare!!
        }
        _SiArrowUpwardSquare = ImageVector.Builder(
            name = "Regular.SiArrowUpwardSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SiArrowUpwardSquare: ImageVector? = null
