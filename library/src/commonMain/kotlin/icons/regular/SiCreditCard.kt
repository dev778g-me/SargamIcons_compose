...
val Sargam.Regular.SiCreditCard: ImageVector
    get() {
        if (_SiCreditCard != null) {
            return _SiCreditCard!!
        }
        _SiCreditCard = ImageVector.Builder(
            name = "Regular.SiCreditCard",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SiCreditCard: ImageVector? = null
