...
val Sargam.Regular.SiDollarAlt2: ImageVector
    get() {
        if (_SiDollarAlt2 != null) {
            return _SiDollarAlt2!!
        }
        _SiDollarAlt2 = ImageVector.Builder(
            name = "Regular.SiDollarAlt2",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SiDollarAlt2: ImageVector? = null
