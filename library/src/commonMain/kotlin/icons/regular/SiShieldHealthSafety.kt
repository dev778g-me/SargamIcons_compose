...
val Sargam.Regular.SiShieldHealthSafety: ImageVector
    get() {
        if (_SiShieldHealthSafety != null) {
            return _SiShieldHealthSafety!!
        }
        _SiShieldHealthSafety = ImageVector.Builder(
            name = "Regular.SiShieldHealthSafety",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SiShieldHealthSafety: ImageVector? = null
