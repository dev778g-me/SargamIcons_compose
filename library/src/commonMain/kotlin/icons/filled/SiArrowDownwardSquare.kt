...
val Sargam.Filled.SiArrowDownwardSquare: ImageVector
    get() {
        if (_SiArrowDownwardSquare != null) {
            return _SiArrowDownwardSquare!!
        }
        _SiArrowDownwardSquare = ImageVector.Builder(
            name = "Filled.SiArrowDownwardSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SiArrowDownwardSquare: ImageVector? = null
