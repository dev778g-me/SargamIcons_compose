...
val Sargam.Filled.SiArrowLeftSquare: ImageVector
    get() {
        if (_SiArrowLeftSquare != null) {
            return _SiArrowLeftSquare!!
        }
        _SiArrowLeftSquare = ImageVector.Builder(
            name = "Filled.SiArrowLeftSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SiArrowLeftSquare: ImageVector? = null
