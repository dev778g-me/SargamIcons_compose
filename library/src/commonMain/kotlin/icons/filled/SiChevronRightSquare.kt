...
val Sargam.Filled.SiChevronRightSquare: ImageVector
    get() {
        if (_SiChevronRightSquare != null) {
            return _SiChevronRightSquare!!
        }
        _SiChevronRightSquare = ImageVector.Builder(
            name = "Filled.SiChevronRightSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SiChevronRightSquare: ImageVector? = null
