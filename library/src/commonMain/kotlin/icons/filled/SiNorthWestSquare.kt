...
val Sargam.Filled.SiNorthWestSquare: ImageVector
    get() {
        if (_SiNorthWestSquare != null) {
            return _SiNorthWestSquare!!
        }
        _SiNorthWestSquare = ImageVector.Builder(
            name = "Filled.SiNorthWestSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SiNorthWestSquare: ImageVector? = null
