    ...
    get() {
        ...
        _SiNorthWestEscape = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(17.482f, 6f, 19f, 7.518f, 19f, 9.4f)
                verticalLineToRelative(6.2f)
                curveToRelative(0f, 1.882f, -1.518f, 3.4f, -3.4f, 3.4f)
                horizontalLineTo(9.4f)
                arcTo(3.394f, 3.394f, 0f, isMoreThanHalf = false, isPositiveArc = true, 6f, 15.6f)
                verticalLineTo(15f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = true, isPositiveArc = true, 2f, 0f)
