...
val Sargam.Filled.SiExpandLessSquare: ImageVector
    get() {
        if (_SiExpandLessSquare != null) {
            return _SiExpandLessSquare!!
        }
        _SiExpandLessSquare = ImageVector.Builder(
            name = "Filled.SiExpandLessSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SiExpandLessSquare: ImageVector? = null
