...
val Sargam.Filled.SiSouthWestSquare: ImageVector
    get() {
        if (_SiSouthWestSquare != null) {
            return _SiSouthWestSquare!!
        }
        _SiSouthWestSquare = ImageVector.Builder(
            name = "Filled.SiSouthWestSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SiSouthWestSquare: ImageVector? = null
